...
public class Tokenizer { 
	...
	protected String stringToBeRead;
...
/**
 * 
 * TODO: this should be refactored again as the createStringReader and setReader-
 *  don't belong to this method.
 * This is how the setString method looks like after it has been refactored
 * The string to be read is passed as an argument and its value is assigned to the property called stringToBeRead.
 * Then an instance of the StringReader class is created.
 * Then this String StringReader is passed to the PushbackReader with the DEFAULT_SYMBOL_MAX
 * Set the string to read from.
 * 
 * @param   String   the string to read from
 */
public void setString(String s) {
	this.stringToBeRead = s;
	createStringReader();
	setReader(new PushbackReader(this.stringReader, DEFAULT_SYMBOL_MAX));
}



/**
 * Old version of setString
 * Set the string to read from.
 * 
 * @param   String   the string to read from
 */
...
/**
 * This method is no longer needed as it required using other to classes to run.
 * Now each class instantiation has its own method and now they can be easily tested.
 * 
 * Set the string to read from.
 * 
 * @param   String   the string to read from
 ...
 */
//public void setString(String s, int symbolMax) {
//	System.out.println("from setString"+" "+s);
//	setReader(
//		new PushbackReader(new StringReader(s), symbolMax));
//}
...
/**
 * Instantiates a StringReader object and passes the strignToBeRead as a parameter
 */
public void createStringReader() {
	this.stringReader = new StringReader(this.stringToBeRead);
}

/**
 * This is an alternative to the setReader() method
 * @param sr
 * @param symbolMax
 */
public void passReaderToPushbackReader(StringReader sr, int symbolMax){
	this.reader = new PushbackReader(sr, symbolMax);
}
